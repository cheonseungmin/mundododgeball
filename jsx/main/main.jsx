    ...
    login() {
        ...
        axios.post('/login', {
            ...
            if (this.state.state == 'login') {
                ...
                this.socket = socketIo.connect('http://ec2-13-125-255-208.ap-northeast-2.compute.amazonaws.com:3000/') //서버의 주소, 제 경우에는 집에서 포트 포워딩을 통해 서버를 열었습니다.
                ...
                this.socket.on('error', function (data) {
                    ...
                    window.location.href = 'http://ec2-13-125-255-208.ap-northeast-2.compute.amazonaws.com:3000/'
                    // 서버로 재접속을 시도합니다.
                }.bind(this))
